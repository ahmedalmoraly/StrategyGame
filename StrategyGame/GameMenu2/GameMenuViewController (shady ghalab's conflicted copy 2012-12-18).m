...
- (void)viewDidLoad
{
    [super viewDidLoad];
        ...
        // UIImage *image =    [GameMenuViewController captureScreen];
        //UIImageView *imageee =  [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 50, 50)];
    
        //   [imageee setImage:image];
        //  [self.view addSubview:imageee];
        // [self.view bringSubviewToFront:imageee];
